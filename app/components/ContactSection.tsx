				...
				>
					...
					<div className="relative z-10">
						...
						<div className="font-mono">
							...
							<motion.a
								href="mailto:shaishav.dev@gmail.com"
							...
							>
								shaishav.dev@gmail.com
							</motion.a>
							<p className="text-green-500 mt-8 mb-2">$ cat resume.pdf</p>
							<motion.a
								href="https://drive.google.com/file/d/1FOGXYtydvmV3Ozdqhd2sZDsMIj-lKPDn/view?usp=drive_link"
								target="_blank"
							...
							<div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4">
								<motion.a
									href="https://github.com/codecrafted7"
								...
								>
									...
									<div>
										...
										<p className="text-sm text-gray-400">@CodeCrafted7</p>
									</div>
								</motion.a>
								<motion.a
									href="https://www.linkedin.com/in/shaishav-gupta/"
									whileHover={{ scale: 1.05 }}
									className="flex items-center gap-3 px-4 py-3 bg-gray-800/50 rounded-lg hover:bg-gray-700/50 transition-colors border border-gray-700/50 group"
								>
									<div className="p-2 bg-gray-700/50 rounded-lg group-hover:bg-gray-600/50 transition-colors">
									...
									<div>
										...
										<p className="text-sm text-gray-400">Shaishav Gupta</p>
									</div>
								</motion.a>
								<motion.a
									href="https://x.com/Shaishav_Gupta_"
									whileHover={{ scale: 1.05 }}
									className="flex items-center gap-3 px-4 py-3 bg-gray-800/50 rounded-lg hover:bg-gray-700/50 transition-colors border border-gray-700/50 group"
								>
									<div className="p-2 bg-gray-700/50 rounded-lg group-hover:bg-gray-600/50 transition-colors">
									...
									<div>
										...
										<p className="text-sm text-gray-400">@Shaishav_Gupta_</p>
									</div>
								</motion.a>
							</div>
						</div>
